    ...
    public partial class LastVersion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1007 Mountain Drive, Gotham City, NJ", "Wayne Enterprises", new DateTime(2024, 10, 17, 1, 14, 37, 760, DateTimeKind.Local).AddTicks(4311), "bruce.wayne@wayneenterprises.com", "Bruce Wayne", "+1 555-0100" },
                    { 2, "350 5th St, Metropolis, NY", "Daily Planet", new DateTime(2024, 10, 17, 1, 14, 37, 760, DateTimeKind.Local).AddTicks(4322), "clark.kent@dailyplanet.com", "Clark Kent", "+1 555-0199" },
                    { 3, "Paradise Island, Themyscira", "Amazonian Technologies", new DateTime(2024, 10, 17, 1, 14, 37, 760, DateTimeKind.Local).AddTicks(4324), "diana.prince@themyscira.com", "Diana Prince", "+1 555-0142" },
                    { 4, "800 15th St, Coast City, CA", "Ferris Aircraft", new DateTime(2024, 10, 17, 1, 14, 37, 760, DateTimeKind.Local).AddTicks(4325), "hal.jordan@greenlantern.com", "Hal Jordan", "+1 555-0166" },
                    { 5, "123 Main St, Central City, KS", "Central City Police Department", new DateTime(2024, 10, 17, 1, 14, 37, 760, DateTimeKind.Local).AddTicks(4327), "barry.allen@ccpd.com", "Barry Allen", "+1 555-0123" }
                });
